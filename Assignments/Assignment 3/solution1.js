...
var Tiger = /** @class */ (function (_super) {
    ...
    Tiger.prototype.roar = function () {
        ...
        console.log("".concat(this.name, " ").concat(this.species, " is roaring"));
    };
    return Tiger;
}(AnimalClass));
var objAnimalClass = new AnimalClass("Tiger", "Panthera");
var objtigerClass = new Tiger(objAnimalClass.name, objAnimalClass.species);
objtigerClass.roar();
